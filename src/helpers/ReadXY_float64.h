#ifndef READ_XY_FLOAT64_H
#define READ_XY_FLOAT64_H
...
static void Read_NODE_COORD_SECTION(py::array_t<double>);
...
void ReadXY_float64(py::str, py::array_t<double>);

#endif // READ_XY_FLOAT64_H